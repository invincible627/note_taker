# note_taker
A graphic note taker with Python that has the ability to save files in txt format 
## availeble languages
english and persian
...
# دفترچه یادداشت
یک دفترچه ی یادداشت گرافیکی با پایتون که قابلیت ذخیره ی فایل رو هم داره به فرمت txt
## زبانهای در دسترس
انگلیسی و فارسی
### کتابخانه های مورد استفاده برای این برنامه
wxpython, json
#### نحوه اجرا
